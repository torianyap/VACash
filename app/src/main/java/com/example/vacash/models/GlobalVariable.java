...
public class GlobalVariable {
    ...
    public static void init () {
        ...
        // CoD
        GameWithItems cod = new GameWithItems("Call of Duty", "PC", "Activision", 4.3, R.drawable.eldenring);
        ...
        // Valorant
        GameWithItems valorant = new GameWithItems("Valorant", "PC", "Riot  Games", 4.6, R.drawable.eldenring);
        ...
        // FIFA
        GameWithItems fifa = new GameWithItems("FIFA 20", "PC", "EA Sports", 4.7, R.drawable.eldenring);
        ...
        // Minecraft
        GameWithItems minecraft = new GameWithItems("Minecraft", "PC", "Mojang Studios", 4.3, R.drawable.eldenring);
        ...
        // Elden Ring
        GameWithItems eldenring = new GameWithItems("Elden Ring", "Console", "Bandai Namco", 4.5, R.drawable.eldenring);
        ...
        // Animal
        GameWithItems animal = new GameWithItems("Animal Crossing", "Console", "Nintendo", 4.4, R.drawable.eldenring);
        ...
        // Pokemon
        GameWithItems pokemon = new GameWithItems("Pokemon Arceus", "Console", "Nintendon & Pokemon", 4.3, R.drawable.eldenring);
        ...
        // Hogwarts
        GameWithItems hogwarts = new GameWithItems("Hogwarts Legacy", "Console", "Warner Bros", 4.6, R.drawable.eldenring);
        ...
        // Sims
        GameWithItems sims = new GameWithItems("The Sims 4", "Console", "Electronic Arts", 4.3, R.drawable.eldenring);
